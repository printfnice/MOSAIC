...
- A ten-cell CPU audit demo for smoke-level inference; checkpoints are intentionally excluded.
...
The `v8.1.2-submission` snapshot contains the CPU audit demo and compact evidence
