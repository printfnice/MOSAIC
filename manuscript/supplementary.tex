...
The local release builder stages code, configuration, one P1/seed-42 checkpoint, ten transformed demonstration cells, compact evidence tables, commands, environment metadata and SHA-256 hashes. It excludes raw participant data and full caches. This bundle is a local staging artifact rather than a public release: repository access is recorded in the main manuscript, while archived-release metadata, DOI and public checkpoint availability remain pending the external upload step. The panel-aware and RNA-CP10K sensitivity artifacts remain local evidence until the public package is rebuilt.
