...
\\
\textbf{Availability and Implementation:} Code, configurations, evidence, tests and a ten-cell CPU audit demo are available under MIT at \url{https://github.com/printfnice/MOSAIC/tree/v8.1-submission}; raw data, caches, predictions and checkpoints are excluded.
\\
...
Code, configurations, split manifests, compact evidence, tests, environment metadata, checksums and a ten-cell CPU audit demo are available under MIT at \url{https://github.com/printfnice/MOSAIC/tree/v8.1-submission} in the tagged snapshot. Raw data, caches, full predictions and checkpoints are not redistributed; an immutable archive DOI is not assigned in this snapshot.
